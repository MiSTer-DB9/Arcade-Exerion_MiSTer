...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Exerion_MiSTer.git"
CORE_NAME=(Arcade-Exerion)
...
UPSTREAM_CORE_NAME=(Arcade-Exerion)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Exerion.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Exerion.rbf)
